...
class DetailEventController extends Controller
{
    public function show(Request $request)
    {
        ...
        if (!$id) {
            return redirect('/en/events')->with('error', 'Event ID is missing!');
        }
        ...
        if (!$events) {
            return redirect('/en/events')->with('error', 'Event not found!');
        }
        ...
        return view('partials.details_event', compact('events', 'reviews', 'averageRating'));
    }
